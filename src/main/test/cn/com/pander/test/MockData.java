...
public class MockData {
	...
	public static void mock(JavaSparkContext sc,SQLContext sqlContext) 
	{
		...
		StructType schema = DataTypes.createStructType(Arrays.asList(
		 ...
		 Dataset<Row> ds=sqlContext.createDataFrame(rowsRdd, schema);
		 ds.createOrReplaceTempView("user_visit_action");
		 ds.show();
		 for(Row _row : ds.takeAsList(1)) 
		 {
		 ...
		 String[] sexes = new String[]{"male", "female"};
			...
			Dataset<Row> ds2=sqlContext.createDataFrame(rowsRdd, schema2);
			ds2.createOrReplaceTempView("user_info");
			ds2.show();
			for(Row _r : ds2.takeAsList(1)) 
			{
